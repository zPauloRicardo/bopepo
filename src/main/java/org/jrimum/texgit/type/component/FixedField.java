...
public class FixedField<G> extends Field<G> implements org.jrimum.texgit.type.FixedField<G> {
	 ...
	 * </p>
	 */
	private org.jrimum.texgit.type.Filler filler;
	...
	public FixedField(G value, Integer length, org.jrimum.texgit.type.Filler filler) {
		super(value);
		setFixedLength(length);
		setFiller(filler);
	}
	...
	public FixedField(G value, Integer length, Format formatter, org.jrimum.texgit.type.Filler filler) {
		super(value,formatter);
		setFixedLength(length);
		setFiller(filler);
	}
	...
	public FixedField(String name, G value, Integer length, org.jrimum.texgit.type.Filler filler) {
		super(name,value);
		setFixedLength(length);
		setFiller(filler);
	}
	...
	public FixedField(String name, G value, Integer length, Format formatter, org.jrimum.texgit.type.Filler filler) {
		super(name,value,formatter);
		setFixedLength(length);
		setFiller(filler);
	}
	...
	/**
	 * @see Field#read(java.lang.String)
	 */
	@Override
	...
	public org.jrimum.texgit.type.Filler getFiller() {
		return filler;
	}
